      ...
      <main className="container mx-auto p-6">
        <TabGroup>
          <TabList className="flex space-x-1 rounded-xl bg-slate-200 p-1 mb-8">
            {[
              { name: "Portfolio", icon: ChartBarIcon },
              { name: "Deposit", icon: BanknotesIcon },
              { name: "Withdraw", icon: Wallet },
              { name: "Performance", icon: ArrowTrendingUpIcon },
              { name: "Asset", icon: ArrowDownTrayIcon },
            ].map((tab) => (
              <Tab
                key={tab.name}
                className={({ selected }) =>
            ...
            <TabPanel className="bg-white rounded-xl shadow p-6">
              ...
              <div className="max-w-md mx-auto">
                ...
                <p className="text-slate-500 text-sm mt-4">
                  Withdrawals typically process within 3-5 business days. A $25
                  fee applies for expedited processing.
                </p>
              </div>
            </TabPanel>
