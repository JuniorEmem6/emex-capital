      ...
      <footer className="bg-slate-900 border-t border-slate-800/50">
        <div className="container mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {/* Column 1: Logo & About */}
            <div>
              <div className="flex items-center mb-6 ml-[250px]">
                <img 
                  src={EmexLogo} 
                  alt="Emex Capital" 
              ...
              <p className="text-slate-400 mb-6 ml-[265px] mt-[-18px] text-[13px]">
            ...
            <div className="flex mt-[-50px] justify-around items-center">
            <div>
              ...
              <ul >
                {[
                  ...
                  <li key={item.name}>
                    <a 
                      href={item.href} 
                      className="text-slate-400 hover:text-amber-400 transition-colors text-[15px]"
                    >
                      {item.name}
                    </a>
                  </li>
            ...
            <div>
              ...
              <address className="not-italic text-slate-400 space-y-3 text-[15px]">
