...
export default function LiveMarketChart() {
  const [activeTab, setActiveTab] = useState("EURUSD"); // Default to S&P 500

  const marketTabs = [
    { id: "SPX", name: "S&P 500", symbol: "SPX" },
    { id: "NDX", name: "NASDAQ 100", symbol: "NDX" },
    { id: "BTC", name: "Bitcoin", symbol: "BTCUSD" },
    { id: "XAUUSD", name: "Gold", symbol: "XAUUSD" },
    { id: "USDJPY", name: "USDJPY", symbol: "USDJPY" },
    { id: "EURUSD", name: "EURUSD", symbol: "EURUSD" },
  ];

  return (
    <section className="py-20 bg-linear-to-b from-slate-900 to-slate-700">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-500 mb-4">
            <span className="text-amber-400">Market Intelligence</span> At Your
            Fingertips
          </h2>
